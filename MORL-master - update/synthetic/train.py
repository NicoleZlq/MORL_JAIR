...
parser.add_argument('--episode-num', type=int, default=2500, metavar='EN',
...
def train(env, agent, args):
    ...
    for num_eps in range(args.episode_num):
        ...
        while not terminal:
            ...
            loss_delta, sample_q, back_time = agent.learn()

            train_time += back_time
            loss += loss_delta
        ...
        if num_eps%20 == 0:
            monitor.update(num_eps,
                           ...
                           loss / cnt)
            #*********************
            monitor.calculate_time(train_time,epoch_time, num_eps)
