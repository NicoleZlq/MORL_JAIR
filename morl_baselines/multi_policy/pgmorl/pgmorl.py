...
class PGMORL(MOAgent):
    ...
    def __eval_all_agents(
        ...
        if self.log :
            ...
            print(self.global_step, iteration)
            

    def __task_weight_selection(self, ref_point: np.ndarray):
        """Chooses age and weights to train at the next iteration based on the current population and prediction model."""
    ...
    def train(
        ...
        while iteration < max_iterations:
            print(iteration, max_iterations,2222222222)
            ...
            if self.log:
                ...
                self.global_step = iteration * 6000
